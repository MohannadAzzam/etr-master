...
class ListPaginationGridSliver extends StatefulWidget {
  ...
  const ListPaginationGridSliver({this.buildItem, this.url, this.fun, this.pagingController, this.controller, this.physics, this.shrinkWrap=false, this.scrollController, this.extraValue, this.extraValueKey, this.buildHeader, this.title='', this.headerList, this.gridDelegate, this.padding, }) ;

  @override
  _ListPaginationGridSliverState createState() => _ListPaginationGridSliverState();
}

class _ListPaginationGridSliverState extends State<ListPaginationGridSliver> with SingleTickerProviderStateMixin {
      ...
      child: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers:[
            ...
            SliverPadding(
              padding: widget.padding??EdgeInsets.symmetric(horizontal: 10.w,vertical: 5),
              sliver: PagedSliverGrid<int, dynamic>(
