...
class ProfileScreenSponsor extends StatefulWidget {
   const ProfileScreenSponsor({Key key}) : super(key: key);
            ...
            SliverOverlapAbsorber(
              ...
              //  title: const Text('الملف الشخصي'), // This is the title in the app bar.
                ...
                actions: [IconButton(onPressed: (){
                  bottomSheet(context: context, child: DialogEditProfile());
                ...
                sliver: SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20.h),
                      myText('Sponsors_Packages'.t,icon: 'medal_icon',color: fPrimaryColor,fontSize: 20.sp,fontWeight: FontWeight.w800),
                      GetMyObject(
                        url: apiMyProfile,
                        keyO: 'user',
                        ...
                        onHasData: (value) {
                          return Column(
                            children: [
                              myText('messageSponsorProfile'.t) ,
                              SizedBox(height: 10.h),

                              Center(child: DefaultButton(onPressed: (){
                                //To(context, SelectPlaceScreen());
                                To(context, const ChoosePackageScreen());
                              }, text: 'be_sponsor'.t,icon: 'medal_icon',isExpanded: false,))
                            ],
                          );
                        },
                      )
